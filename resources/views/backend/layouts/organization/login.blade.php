...
<div class="login-dark">
    ...
    <form method="post" action="{{route('user.do.login')}}" type="form">
        ...
        <div class="form-group"><a href="{{route('organization.view')}}" class="btn btn-primary btn-block" type="submit">Log In</a></div><a href="#" class="forgot">Forgot your email or password?</a></form>
</div>
